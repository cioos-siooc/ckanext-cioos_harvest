...
from ckantoolkit import get_action, side_effect_free
from shapely import wkt as shapely_wkt

from ckanext.spatial.lib import fit_bbox, normalize_bbox
...
def spatial_query_geo_package_search(context, data_dict):
    ...
    """
    search_params = {k: v for k, v in data_dict.items() if k not in ("bbox", "poly")}
